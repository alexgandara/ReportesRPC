...
public class _TicketeraMiniPos {
  ...
  public static void main (String args[]) {
    ...
    try {
		_TicketMiniPos ticket = new _TicketMiniPos(store, venue, "5", "99", caissier, date, items, "100.00", "16.00", "116.00", "150", "34", caissier, caissier, caissier, caissier, caissier, caissier, caissier, caissier, caissier, caissier, caissier, caissier, caissier);
	} catch (IOException e) {
