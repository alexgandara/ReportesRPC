...
public class readXML {
	...
	//		System.out.println("Serie _ _ _ _ _ _ _ _ _ _ _ _ _: " + _temp);
	//		Cabecera.set_serie(_temp.substring(0,4));
	//		int _tam=_temp.length();
			
	//		Cabecera.set_folio(_temp.substring(5,_tam));
	...
	//		System.out.println("Folio _ _ _ _ _ _ _ _ _ _ _ _ _: " + Cabecera.get_folio());
			...
			NodeList nList_IssueDateV = doc.getElementsByTagName("cbc:PaymentDueDate");
			Node nNode_IssueDateV = nList_IssueDateV.item(0);
			
			String _fechaV = nNode_IssueDateV.getTextContent();
			
			String _DiaV = "";
			String _MesV = "";
			String _AnoV = "";
			_DiaV = _fechaV.substring(8, 10);  //2016.09.17  2016-11-30
			_MesV = _fechaV.substring(5, 7);  //2016.09.17  0123456789
			_AnoV = _fechaV.substring(0, 4);             // 1234567890
			Cabecera.set_fecha_vencimiento(_DiaV+"/"+_MesV+"/"+_AnoV);
			System.out.println("Fecha de Vencimiento: _ _ _ _ _: " + Cabecera.get_fecha_vencimiento());	
	...
	//		System.out.println("Condiciones_ _ _ _ _ _ _ _ __ _ _ _ _ : " + Cabecera.get_condiciones());
		...
		//		System.out.println("ID:"+_id+" "+"Payable:"+_PayableAmount);
				...
				if (_id.equals("2005")) {
					//cbc:PayableAmount descuento globales
					Cabecera.set_descuentos_cabecera(_PayableAmount);
		...
		//	Cabecera.set_total(Double.parseDouble(nNode_total.getTextContent()));
			...
			Cabecera.set_total(_PayableAmount_total-Cabecera.get_descuentos_cabecera());
...
//			System.out.println("Importe con Letra _ _ _ _ _ _ : " + Cabecera.get_total_letra());
			...
			for (int temp = 0; temp < nList_rel.getLength(); temp++) {
				...
				if (_id.equals("1108")) {
					Cabecera.set_linea08(_texto);
					System.out.println("1108:"+Cabecera.get_linea08());
				}
